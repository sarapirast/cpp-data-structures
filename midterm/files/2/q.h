...
class MyVector {
 public:
  // Creates an empty vector. (Provided in q.cc. No need further modifications.)
  MyVector();
  ...
  // Destructor. 
  // Should delete data and set it to nullptr.
  // (Provided in q.cc. No need further modifications.)
  ~MyVector();
